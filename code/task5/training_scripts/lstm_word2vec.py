...
from features.word2vec import load_word2vec_embeddings, save_word2vec_embeddings
...
LOG_SAVE_PATH   = "./code/task5/loss_points/lstm_word2vec.txt"
...
# Model
# ==========================
print(f"\n[Model] Initializing LSTMModel(input_size={INPUT_SIZE}, hidden_size={HIDDEN_SIZE})")
