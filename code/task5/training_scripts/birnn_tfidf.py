...
from features.tfidf import get_tfidf_features
...
HIDDEN_SIZE          = 32
LR                   = 0.001
MODEL_SAVE_PATH      = "./saved_models/birnn_tfidf.pth"
VECTORIZER_SAVE_PATH = "./saved_models/tfidf_vectorizer.pkl"
...
X_train_vec, X_test_vec, vectorizer = get_tfidf_features(X_train, X_test, max_features=5000)
...
model = BiRNNModel(input_size=1, hidden_size=HIDDEN_SIZE)
model.to(device)
