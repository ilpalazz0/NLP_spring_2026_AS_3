...
function Word2VecPage() {
  ...
  return (
    <div className="page w2v-page">

      {/* ── Header ── */}
      <div className="page-header">
        <div className="page-header__tag">EMBEDDINGS</div>
        <h1 className="page-header__title">Word2Vec <span>Analysis</span></h1>
        <p className="page-header__sub">Solve semantic vector equations using trained Word2Vec embeddings</p>
      </div>
